  ...
  return (
    ...
    <Column maxWidth="m" gap="xl" horizontal="center">
      <Schema
        ...
        title={content.home.title}
        description={content.home.description}
        image={`/api/og/generate?title=${encodeURIComponent(content.home.title)}`}
        author={{
      ...
      <Column fillWidth paddingY="24" gap="m">
        <Column maxWidth="s">
          {content.home.featured.display && (
          <RevealFx fillWidth horizontal="start" paddingTop="16" paddingBottom="32" paddingLeft="12">
            <Badge background="brand-alpha-weak" paddingX="12" paddingY="4" onBackground="neutral-strong" textVariant="label-default-s" arrow={false}
              href={content.home.featured.href}>
              <Row paddingY="2">{content.home.featured.title}</Row>
            </Badge>
          </RevealFx>
          )}
          ...
          <RevealFx paddingTop="12" delay={0.4} horizontal="start" paddingLeft="12">
            <Button
              id="about"
              data-border="rounded"
              href={getUrlWithLang(content.about.path)}
              variant="secondary"
              size="m"
              weight="default"
              arrowIcon
